(function(g) {
            ...
            if (g.isPlainObject(d)) w(d);
                ...
                if (o) {
                    var c = d.childNodes[0],
                        e, f, i = [];
                    for (e = c.attributes.length - 1; 0 <= e; e--) { f = c.attributes[e].nodeName; var j = c.attributes[e].nodeValue; - 1 !== f.indexOf(":") && (i.push({ name: f, value: j }), c.removeAttribute(f)) }
                    e = 0;
    ...
    h.Api.register("buttons.resize()", function() { g.each(i.clients, function(a, b) { b.domElement !== q && b.domElement.parentNode && b.positionElement() }) });
    ...
    h.ext.buttons.excelFlash = g.extend({}, t, {
        ...
        action: function(a, b, d, c) {
            ...
            var a = c._flash,
                ...
                k, l, h = function(a) {
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        j || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? j = n(f, "c", { attr: { t: "n", r: h }, children: [n(f, "v", { text: a[b] })] }) : (o = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), j = n(f, "c", { attr: { t: "inlineStr", r: h }, children: { row: n(f, "is", { children: { row: n(f, "t", { text: o }) } }) } })));
                        l.appendChild(j)
                    }
                    i.appendChild(l);
                    e++
            ...
            m = 0;
            for (r = j.header.length; m < r; m++) h.appendChild(n(f, "col", { attr: { min: m + 1, max: m + 1, width: B(j, m), customWidth: 1 } }));
